...
export class ExpressServicePage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public geolocation: Geolocation, public googleMaps: GoogleMaps, public loadingCtrl: LoadingController) {
